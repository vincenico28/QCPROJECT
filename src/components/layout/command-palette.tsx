...
const PAGES = [
  ...
  { to: "/finance", label: "Finance & Treasury", icon: Banknote },
  { to: "/disputes", label: "Adjudication & Disputes", icon: Scale },
  { to: "/dispatch", label: "Dispatch Board", icon: Radio },
  { to: "/dispatch-hotline", label: "911 Emergency Hotline", icon: PhoneCall },
  { to: "/cameras", label: "Cameras & 4K Feeds", icon: Video },
  { to: "/map", label: "GIS Spatial Map", icon: MapIcon },
  { to: "/vehicles", label: "Vehicle Registry", icon: Car },
  { to: "/officers", label: "Officers & Enforcers", icon: Users },
  { to: "/analytics", label: "Analytics & KPI Trends", icon: BarChart3 },
  { to: "/infrastructure", label: "Infrastructure Health", icon: Activity },
  { to: "/iot", label: "IoT Edge Telemetry", icon: Cpu },
  { to: "/automation", label: "Automation Rules", icon: Workflow },
  { to: "/ai-training", label: "AI Model Training", icon: Sparkles },
  { to: "/tv-display", label: "Command TV Display Mode", icon: Tv },
  { to: "/developer", label: "Developer API Portal", icon: KeyRound },
