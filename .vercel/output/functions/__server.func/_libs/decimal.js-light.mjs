...
var decimal_exports = /* @__PURE__ */ __exportAll({
	Decimal: () => Decimal,
...
var MAX_DIGITS, defaults, Decimal, external, decimalError, invalidArgument, exponentOutOfRange, mathfloor, mathpow, isDecimal, ONE, BASE, LOG_BASE, MAX_SAFE_INTEGER, MAX_E, P, divide, decimal_default;
var init_decimal = __esmMin((() => {
	MAX_DIGITS = 1e9;
	defaults = {
		precision: 20,
		rounding: 4,
...
//#endregion
export { init_decimal as n, decimal_exports as t };
