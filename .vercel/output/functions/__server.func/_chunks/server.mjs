...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CGCLMRil.mjs");
...
var manifest = { "f76b2e957fbc579340314e4efc58ef0a13bf26646c0e0c8dfc5933d699117528": {
	functionName: "lookupCitation_createServerFn_handler",
	importer: () => import("./citation-lookup.functions-D8KdZ7BA.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CsIn8Ssg.mjs").then((n) => n.t),
		import("./start-BRE48NXy.mjs"),
...
//#endregion
export { server_default as i, createServerFn as n, getServerFnById as r, TSS_SERVER_FUNCTION as t };
