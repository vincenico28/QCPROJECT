...
import { n as HTTPError, r as toEventHandler, t as H3Core } from "./_libs/h3+rou3+srvx.mjs";
import { r as NodeResponse } from "./_libs/h3-v2+rou3+srvx.mjs";
import { i as server_default } from "./_chunks/server.mjs";
...
const findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: toEventHandler(server_default)
	};
	return ((_m, p) => {
		return {
			data,
